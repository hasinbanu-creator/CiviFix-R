...
def create_report():
    ...
    # Set Column Widths
    ws.column_dimensions['A'].width = 15 # SUMMARY Text
    ws.column_dimensions['B'].width = 15 # Test ID
    ws.column_dimensions['C'].width = 20 # Module
    ws.column_dimensions['D'].width = 35 # Feature/Test Name
    ws.column_dimensions['E'].width = 40 # Error Message
    ws.column_dimensions['F'].width = 12 # Status
    ws.column_dimensions['G'].width = 20 # Browser
    ...
    # Rows 3-9: Summary Metrics Background
    ...
    # Row 10: Detailed Test Cases Title
    ...
    for i in range(1, 401):
        ...
        ws[f'B{row}'].font = Font(color="3BBA9C")
    ...
    # Save Report
    report_name = "CiviFix_Selenium_Execution_Report.xlsx"
    wb.save(report_name)
